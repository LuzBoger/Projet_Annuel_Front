...
export function TopicCard({ topic, onClick }: TopicCardProperties) {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 mt-6 flex items-center text-sm font-medium text-indigo-600 dark:text-indigo-400 group-hover:text-indigo-700 dark:group-hover:text-indigo-300">
