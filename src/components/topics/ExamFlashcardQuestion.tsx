        ...
        >
            ...
            <div className="w-full max-w-lg mx-auto">
                <input
                    ...
                    className="w-full p-5 sm:p-6 text-lg sm:text-xl text-center border-2 border-gray-200 rounded-2xl focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none bg-gray-50 hover:bg-white placeholder:text-gray-300"
                />
            </div>
        </PlayerCard>
    );
