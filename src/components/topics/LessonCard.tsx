...
export function LessonCard({ lesson, index, onClick }: LessonCardProps) {
    ...
    return (
        <div 
            className="group relative flex flex-col justify-between p-6 bg-white bg-opacity-70 backdrop-blur-lg border border-gray-200 border-opacity-50 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden h-full"
