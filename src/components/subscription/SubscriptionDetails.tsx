...
export function SubscriptionDetails({ subscription }: SubscriptionDetailsProps) {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-slate-200 dark:border-gray-800 shadow-sm overflow-hidden">
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100 dark:border-gray-800 bg-gradient-to-r from-slate-50 to-blue-50 dark:from-gray-900 dark:to-gray-900">
            ...
            <div className="px-6 py-2">
                {subscription.plan?.subscriptionType === 'PREMIUM' && (
                    <>
                        <div className="flex justify-between items-center py-2.5 border-b border-slate-50 dark:border-gray-800 text-sm">
                        ...
                        {subscription.cancelAtPeriodEnd && (
                            <div className="mb-4 p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-gray-800 rounded-xl flex gap-2 items-start">
