                    ...
                    <>
                        ...
                        {subscription.daysRemaining !== null && (
                            <div className="flex justify-between items-center py-2.5 text-sm">
                                <span className="text-slate-500">{t('subscription.details.days_remaining')}</span>
                                <span className={`font-medium ${subscription.daysRemaining <= 7 ? 'text-red-500' : 'text-slate-900'}`}>
