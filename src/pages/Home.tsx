                    ...
                    <div className="space-y-24">
                            ...
                            <div>
                                ...
                                <ul className="space-y-3">
                                    <li className="flex items-start">
                                        <span className="flex-shrink-0 w-5 h-5 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mr-3 mt-1 text-xs">✓</span>
                                        <span className="text-gray-700"><strong>{t('home.science.spaced_repetition.stat1')}</strong>{t('home.science.spaced_repetition.stat1_desc')}</span>
                                    </li>
                                </ul>
                            </div>
                            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 shadow-sm relative overflow-hidden">
                                <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-6">{t('home.science.spaced_repetition.chart_title')}</h4>
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div className="order-2 md:order-1 bg-gray-50 p-6 rounded-xl border border-gray-100 shadow-sm">
                                ...
                                <div className="flex justify-around items-end h-32 px-4 gap-4">
                                    <div className="w-full relative flex flex-col items-center justify-end h-full">
                                        <div className="w-16 bg-gray-300 rounded-t-md text-center text-xs text-gray-700 font-medium py-1" style={{ height: '40%' }}>{t('home.science.dual_coding.text_only')}</div>
                                    </div>
                                    <div className="w-full relative flex flex-col items-center justify-end h-full">
                            ...
                            <div className="order-1 md:order-2">
                                <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('home.science.dual_coding.title')}</h3>
                                <p className="text-gray-600 mb-6 leading-relaxed">
                                ...
                                <ul className="space-y-3">
                                    <li className="flex items-start">
                                        <span className="flex-shrink-0 w-5 h-5 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mr-3 mt-1 text-xs">✓</span>
                                        <span className="text-gray-700">{t('home.science.dual_coding.stat1')}</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="flex-shrink-0 w-5 h-5 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mr-3 mt-1 text-xs">✓</span>
                                        <span className="text-gray-700"><strong>{t('home.science.dual_coding.stat2')}</strong>{t('home.science.dual_coding.stat2_desc')}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <ul className="space-y-3">
                                    <li className="flex items-start">
                                        <span className="flex-shrink-0 w-5 h-5 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mr-3 mt-1 text-xs">✓</span>
                                        <span className="text-gray-700">{t('home.science.testing_effect.stat1_start')}<strong>{t('home.science.testing_effect.stat1_highlight')}</strong>{t('home.science.testing_effect.stat1_end')}</span>
                                    </li>
                                </ul>
                            </div>
                            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 shadow-sm flex items-center justify-center">
                                <div className="text-center">
                                    <div className="inline-block p-4 bg-white rounded-full border border-rose-100 shadow-sm mb-4 relative">
                                    ...
                                    <p className="font-semibold text-gray-700">{t('home.science.testing_effect.chart_title')}</p>
                                    <p className="text-sm text-gray-500">{t('home.science.testing_effect.chart_desc')}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="order-1 md:order-2">
                                <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('home.science.chunking.title')}</h3>
                                <p className="text-gray-600 mb-6 leading-relaxed">
                                ...
                                <ul className="space-y-3">
                                    <li className="flex items-start">
                                        <span className="flex-shrink-0 w-5 h-5 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mr-3 mt-1 text-xs">✓</span>
                                        <span className="text-gray-700">{t('home.science.chunking.stat1')}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
